function [bitRatio, total_bits] = lzss_findRatio(input, string_dict, offset_dict, maxLength_dict, flag_dict, type)

% flag bit
flagbits = length(flag_dict);
...
switch type
    case 'text'        
        ...
        total_bits = offset_bits + length_bits + flagbits + length(codewords);
    ...
    case 'audio'
        ...
        % Find total bits in dictionary
        total_bits = offset_bits + length_bits + flagbits + binEncoded_length;
